                ...
                <div className="about-me__content">
                    <div className="about-me__text-wrapper">
                        <div className="about-me__text-content">
                            ...
                            Живу в городе Магнитогорск, работаю индивидуальным предпринемателем. Предоставляю услуги по разработке и поддержке сайтов. Мой стек - MERN (MongoDB, Express.js, React.js, Node.js). Работаю преимущественно с клиентами из Москвы. После обучения из Яндекс.Практикума начал целиться на работу в большой команде фронтенд разработчиком. Вдохновляюсь веб-технологиями.
                            </p>
                        </div>
